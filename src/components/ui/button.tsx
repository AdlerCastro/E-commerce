...
const buttonVariants = cva(
  'inline-flex font-inter text-base items-center disabled:cursor-none justify-center gap-2 whitespace-nowrap cursor-pointer outline-0 focus-visible:outline-3',
  {
    variants: {
      variant: {
        default:
